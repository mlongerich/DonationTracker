...
- [ ] Cypress E2E test (2 scenarios):
  - Navigate to Reports → select date range → click Generate Report → verify table displays data
  - Navigate to Reports → select date range → click Generate Report → click Download CSV → verify CSV filename
